...
from utils.logging_model import LoggingGeminiModel, create_logging_model
...
def evaluate_on_gaia(
    ...
    SAVE_RESULT_PATH = f"results/workforce/workforce_{LEVEL}_pass{MAX_TRIES}_gemini3flash_p{partition}.json"
